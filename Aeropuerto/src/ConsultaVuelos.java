...
public class ConsultaVuelos {
	...
	public void tarifas(){
		...
		String[][] tarifas = {{"Primera Clase", "100.000"},{"Clase Ejecutiva", "60.000"}, {"Clase Económica", "40.000"}};
		...
		do {
			...
			System.out.println("¿En qué tarifa desea viajar?");
		...
		case "2":
			...
			break;
		case "3":
			System.out.println("Elegiste económica");
			break;
		default:
		  System.out.println("Intente con otro número");
		} 
